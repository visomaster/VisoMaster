...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.gridLayout_7 = QGridLayout(self.gridGroupBox)
        self.gridLayout_7.setObjectName(u"gridLayout_7")
        self.listWidget = QListWidget(self.gridGroupBox)
        self.listWidget.setObjectName(u"listWidget")
        self.listWidget.setAutoFillBackground(True)

        self.gridLayout_7.addWidget(self.listWidget, 0, 1, 1, 1)

        self.listWidget_2 = QListWidget(self.gridGroupBox)
        ...
        sizePolicy6.setHeightForWidth(self.label_tab2.sizePolicy().hasHeightForWidth())
        self.label_tab2.setSizePolicy(sizePolicy6)
