...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon5 = QIcon()
        icon5.addFile(u":/media/Media/fullscreen.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.viewFullScreenButton.setIcon(icon5)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/media/Media/open_file.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.openEmbeddingButton.setIcon(icon6)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/media/Media/save_file.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.saveEmbeddingButton.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/media/Media/save_file_as.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.saveEmbeddingAsButton.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/media/Media/image.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.filterImagesCheckBox.setIcon(icon9)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/media/Media/video.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.filterVideosCheckBox.setIcon(icon10)
