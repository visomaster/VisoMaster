...
def apply_facerestorer(self: 'ModelsProcessor', swapped_face_upscaled, restorer_det_type, restorer_type, restorer_blend, fidelity_weight, detect_score):
...
def run_GFPGAN(self: 'ModelsProcessor', image, output):
...
def run_GPEN_256(self: 'ModelsProcessor', image, output):
...
def run_GPEN_512(self: 'ModelsProcessor', image, output):
...
def run_GPEN_1024(self: 'ModelsProcessor', image, output):
...
def run_GPEN_2048(self: 'ModelsProcessor', image, output):
...
def run_codeformer(self: 'ModelsProcessor', image, output, fidelity_weight_value=0.9):
...
def run_VQFR_v2(self: 'ModelsProcessor', image, output, fidelity_ratio_value):
...
def run_RestoreFormerPlusPlus(self: 'ModelsProcessor', image, output):
