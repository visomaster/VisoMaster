...
from PySide6.QtWidgets import (QApplication, QCheckBox, QComboBox, QDockWidget,
    ...
    QSpacerItem, QStackedWidget, QTabWidget, QVBoxLayout, QWidget)
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        # ── Input Source Tab Widget (Media / Streaming) ──────────────────────
        self.inputSourceTabWidget = QTabWidget(self.dockWidgetContents)
        self.inputSourceTabWidget.setObjectName(u"inputSourceTabWidget")
        self.inputSourceTabWidget.setTabPosition(QTabWidget.TabPosition.North)
        self.inputSourceTabWidget.setTabsClosable(False)

        # ── Media Tab ────────────────────────────────────────────────────────
        self.mediaTab = QWidget()
        self.mediaTab.setObjectName(u"mediaTab")
        self.mediaTabLayout = QVBoxLayout(self.mediaTab)
        self.mediaTabLayout.setObjectName(u"mediaTabLayout")
        self.mediaTabLayout.setContentsMargins(4, 4, 4, 4)
        self.mediaTabLayout.setSpacing(4)

        # Folder row: path label + open button
        self.groupBox_TargetVideos_Select = QGroupBox(self.mediaTab)
        ...
        self.mediaTabLayout.addWidget(self.groupBox_TargetVideos_Select)

        # Search + photo/video filter row
        self.horizontalLayout_9 = QHBoxLayout()
        self.horizontalLayout_9.setObjectName(u"horizontalLayout_9")
        self.targetVideosSearchBox = QLineEdit(self.mediaTab)
        ...
        self.filterImagesCheckBox = QCheckBox(self.mediaTab)
        ...
        self.filterVideosCheckBox = QCheckBox(self.mediaTab)
        ...
        self.mediaTabLayout.addLayout(self.horizontalLayout_9)

        # Target media list
        self.targetVideosList = QListWidget(self.mediaTab)
        ...
        self.mediaTabLayout.addWidget(self.targetVideosList)

        self.inputSourceTabWidget.addTab(self.mediaTab, u"Media")
        ...
        self.streamingTabLayout.setContentsMargins(4, 4, 4, 4)
        self.streamingTabLayout.setSpacing(4)

        # Sub-tab widget: Webcam / WebRTC
        self.streamingSubTabWidget = QTabWidget(self.streamingTab)
        self.streamingSubTabWidget.setObjectName(u"streamingSubTabWidget")
        self.streamingSubTabWidget.setTabPosition(QTabWidget.TabPosition.North)
        self.streamingSubTabWidget.setTabsClosable(False)

        # FPS label as a corner widget — sits right-aligned in the tab bar row
        self.streamingFpsLabel = QLabel(u"FPS: --", self.streamingSubTabWidget)
        self.streamingFpsLabel.setObjectName(u"streamingFpsLabel")
        self.streamingFpsLabel.setAlignment(Qt.AlignmentFlag.AlignVCenter | Qt.AlignmentFlag.AlignRight)
        self.streamingFpsLabel.setContentsMargins(0, 0, 6, 0)
        self.streamingSubTabWidget.setCornerWidget(self.streamingFpsLabel, Qt.Corner.TopRightCorner)

        # ── Webcam sub-tab ───────────────────────────────────────────────────
        self.webcamSubTab = QWidget()
        self.webcamSubTab.setObjectName(u"webcamSubTab")
        self.webcamSubTabLayout = QVBoxLayout(self.webcamSubTab)
        self.webcamSubTabLayout.setObjectName(u"webcamSubTabLayout")
        self.webcamSubTabLayout.setContentsMargins(4, 4, 4, 4)
        self.webcamSubTabLayout.setSpacing(4)

        # Webcam transform controls
        self.webcamTransformLayout = QHBoxLayout()
        self.webcamTransformLayout.setObjectName(u"webcamTransformLayout")
        self.webcamTransformLayout.setSpacing(4)
        webcam_transform_label = QLabel(u"Transform:", self.webcamSubTab)
        self.webcamTransformLayout.addWidget(webcam_transform_label)
        self.webcamBtnRotateCCW = QPushButton(self.webcamSubTab)
        self.webcamBtnRotateCCW.setObjectName(u"webcamBtnRotateCCW")
        self.webcamBtnRotateCCW.setToolTip(u"Rotate 90° Counter-Clockwise")
        self.webcamBtnRotateCCW.setText(u"↺")
        self.webcamBtnRotateCCW.setFixedSize(QSize(28, 28))
        self.webcamBtnRotateCCW.setFlat(True)
        self.webcamTransformLayout.addWidget(self.webcamBtnRotateCCW)
        self.webcamBtnRotateCW = QPushButton(self.webcamSubTab)
        self.webcamBtnRotateCW.setObjectName(u"webcamBtnRotateCW")
        self.webcamBtnRotateCW.setToolTip(u"Rotate 90° Clockwise")
        self.webcamBtnRotateCW.setText(u"↻")
        self.webcamBtnRotateCW.setFixedSize(QSize(28, 28))
        self.webcamBtnRotateCW.setFlat(True)
        self.webcamTransformLayout.addWidget(self.webcamBtnRotateCW)
        self.webcamBtnFlipH = QPushButton(self.webcamSubTab)
        self.webcamBtnFlipH.setObjectName(u"webcamBtnFlipH")
        self.webcamBtnFlipH.setToolTip(u"Flip Horizontally")
        self.webcamBtnFlipH.setText(u"⇔")
        self.webcamBtnFlipH.setFixedSize(QSize(28, 28))
        self.webcamBtnFlipH.setFlat(True)
        self.webcamBtnFlipH.setCheckable(True)
        self.webcamTransformLayout.addWidget(self.webcamBtnFlipH)
        self.webcamBtnFlipV = QPushButton(self.webcamSubTab)
        self.webcamBtnFlipV.setObjectName(u"webcamBtnFlipV")
        self.webcamBtnFlipV.setToolTip(u"Flip Vertically")
        self.webcamBtnFlipV.setText(u"⇕")
        self.webcamBtnFlipV.setFixedSize(QSize(28, 28))
        self.webcamBtnFlipV.setFlat(True)
        self.webcamBtnFlipV.setCheckable(True)
        self.webcamTransformLayout.addWidget(self.webcamBtnFlipV)
        self.webcamRotationLabel = QLabel(u"0°", self.webcamSubTab)
        self.webcamRotationLabel.setObjectName(u"webcamRotationLabel")
        self.webcamRotationLabel.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.webcamTransformLayout.addWidget(self.webcamRotationLabel)
        self.webcamTransformLayout.addStretch()
        self.webcamSubTabLayout.addLayout(self.webcamTransformLayout)

        # Webcam list
        self.webcamList = QListWidget(self.webcamSubTab)
        self.webcamList.setObjectName(u"webcamList")
        self.webcamList.setAutoScroll(False)
        self.webcamSubTabLayout.addWidget(self.webcamList)

        self.streamingSubTabWidget.addTab(self.webcamSubTab, u"Webcam")

        # ── WebRTC sub-tab ───────────────────────────────────────────────────
        self.webrtcSubTab = QWidget()
        self.webrtcSubTab.setObjectName(u"webrtcSubTab")
        self.webrtcSubTabLayout = QVBoxLayout(self.webrtcSubTab)
        self.webrtcSubTabLayout.setObjectName(u"webrtcSubTabLayout")
        self.webrtcSubTabLayout.setContentsMargins(4, 4, 4, 4)
        self.webrtcSubTabLayout.setSpacing(4)

        # WebRTC transform controls
        self.webrtcTransformLayout = QHBoxLayout()
        self.webrtcTransformLayout.setObjectName(u"webrtcTransformLayout")
        self.webrtcTransformLayout.setSpacing(4)
        webrtc_transform_label = QLabel(u"Transform:", self.webrtcSubTab)
        self.webrtcTransformLayout.addWidget(webrtc_transform_label)
        self.webrtcBtnRotateCCW = QPushButton(self.webrtcSubTab)
        self.webrtcBtnRotateCCW.setObjectName(u"webrtcBtnRotateCCW")
        self.webrtcBtnRotateCCW.setToolTip(u"Rotate 90° Counter-Clockwise")
        self.webrtcBtnRotateCCW.setText(u"↺")
        self.webrtcBtnRotateCCW.setFixedSize(QSize(28, 28))
        self.webrtcBtnRotateCCW.setFlat(True)
        self.webrtcTransformLayout.addWidget(self.webrtcBtnRotateCCW)
        self.webrtcBtnRotateCW = QPushButton(self.webrtcSubTab)
        self.webrtcBtnRotateCW.setObjectName(u"webrtcBtnRotateCW")
        self.webrtcBtnRotateCW.setToolTip(u"Rotate 90° Clockwise")
        self.webrtcBtnRotateCW.setText(u"↻")
        self.webrtcBtnRotateCW.setFixedSize(QSize(28, 28))
        self.webrtcBtnRotateCW.setFlat(True)
        self.webrtcTransformLayout.addWidget(self.webrtcBtnRotateCW)
        self.webrtcBtnFlipH = QPushButton(self.webrtcSubTab)
        self.webrtcBtnFlipH.setObjectName(u"webrtcBtnFlipH")
        self.webrtcBtnFlipH.setToolTip(u"Flip Horizontally")
        self.webrtcBtnFlipH.setText(u"⇔")
        self.webrtcBtnFlipH.setFixedSize(QSize(28, 28))
        self.webrtcBtnFlipH.setFlat(True)
        self.webrtcBtnFlipH.setCheckable(True)
        self.webrtcTransformLayout.addWidget(self.webrtcBtnFlipH)
        self.webrtcBtnFlipV = QPushButton(self.webrtcSubTab)
        self.webrtcBtnFlipV.setObjectName(u"webrtcBtnFlipV")
        self.webrtcBtnFlipV.setToolTip(u"Flip Vertically")
        self.webrtcBtnFlipV.setText(u"⇕")
        self.webrtcBtnFlipV.setFixedSize(QSize(28, 28))
        self.webrtcBtnFlipV.setFlat(True)
        self.webrtcBtnFlipV.setCheckable(True)
        self.webrtcTransformLayout.addWidget(self.webrtcBtnFlipV)
        self.webrtcRotationLabel = QLabel(u"0°", self.webrtcSubTab)
        self.webrtcRotationLabel.setObjectName(u"webrtcRotationLabel")
        self.webrtcRotationLabel.setAlignment(Qt.AlignmentFlag.AlignCenter)
        self.webrtcTransformLayout.addWidget(self.webrtcRotationLabel)
        self.webrtcTransformLayout.addStretch()
        self.webrtcSubTabLayout.addLayout(self.webrtcTransformLayout)

        # WebRTC list (placeholder card)
        self.webrtcList = QListWidget(self.webrtcSubTab)
        self.webrtcList.setObjectName(u"webrtcList")
        self.webrtcList.setAutoScroll(False)
        self.webrtcSubTabLayout.addWidget(self.webrtcList)

        self.streamingSubTabWidget.addTab(self.webrtcSubTab, u"WebRTC")

        self.streamingTabLayout.addWidget(self.streamingSubTabWidget)
        self.inputSourceTabWidget.addTab(self.streamingTab, u"Streaming")

        self.vboxLayout.addWidget(self.inputSourceTabWidget)

        # ── Input Faces section (unchanged) ─────────────────────────────────
