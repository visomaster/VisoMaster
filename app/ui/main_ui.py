    ...
    def keyPressEvent(self, event):
        match event.key():
            ...
            case QtCore.Qt.Key_Z:
                video_control_actions.set_video_slider_position(self, new_position=0)
            case QtCore.Qt.Key_Space:
                video_control_actions.play_video(self, True)
            case QtCore.Qt.Key_R:
                video_control_actions.record_video(self, True)
