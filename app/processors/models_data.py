...
# Each entry may include an optional "dev" key (default True).
# Models with "dev": False are excluded from dev-mode downloads but included
# in full-mode downloads. All entries here are the authoritative model registry.
models_list = [
    # ── Face Swappers ────────────────────────────────────────────────────────
    {
...
# Convenience view: only the models included in dev-mode downloads.
models_dev_list = [m for m in models_list if m.get("dev", True)]
